...
let SummaryService = class SummaryService {
    constructor(_angularFireDatabase, _authService) {
    ...
    getAllSummaries() {
        ...
        this.allSummaries = this.allSummariesFire.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => changes.map(c => (Object.assign({ key: c.payload.key }, c.payload.val())))));
        return this.allSummaries;
    }
    // Get summary for that date for that user, if it does not exist, it returns null
    getSummary(selected_date) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    getSummaryObservable(selected_date) {
    ...
    incrementExisitngSummary(existingSummary, entrySummary, selected_date) {
    ...
    decrementExisitngSummary(existingSummary, entrySummary, selected_date) {
        existingSummary.totalCalories -= entrySummary.totalCalories;
        existingSummary.totalGramsCarbohydrates -= entrySummary.totalGramsCarbohydrates;
        existingSummary.totalGramsFats -= entrySummary.totalGramsFats;
        existingSummary.totalGramsProtein -= entrySummary.totalGramsProtein;
...
SummaryService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
...
let LoadingService = class LoadingService {
    ...
    presentLoading(messageText, durationMiliSec) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
/***/ "bu6J":
/*!************************************************!*\
  !*** ./src/app/services/food-entry.service.ts ***!
  \************************************************/
/*! exports provided: FoodEntryService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FoodEntryService", function() { return FoodEntryService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/fire/database */ "36mX");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
...
let FoodEntryService = class FoodEntryService {
    constructor(_angularFireDatabase, _authService) {
        this._angularFireDatabase = _angularFireDatabase;
        this._authService = _authService;
    }
    //Get all foods from database ordered by name for the current user on that date
    getAllFoodEntriesByDate(selected_date) {
        ...
        this.foodEntries = this.foodEntriesFire.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => changes.map(c => (Object.assign({ key: c.payload.key }, c.payload.val())))));
    ...
    getNumberOfFoodEntriesByDate(selected_date) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
FoodEntryService.ctorParameters = () => [
    { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] },
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }
];
FoodEntryService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"],
...
let AuthService = class AuthService {
    ...
    doUpdateDisplayName(profName) {
        return new Promise((resolve, reject) => {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().currentUser.updateProfile({ displayName: profName }).
                then(res => {
                resolve(res);
            }, err => reject(err));
        });
    ...
    doUpdateProfilePhotoURL(profPhoto) {
        return new Promise((resolve, reject) => {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().currentUser.updateProfile({ photoURL: profPhoto }).
                then(res => {
                resolve(res);
            }, err => reject(err));
        });
...
let FoodService = class FoodService {
    ...
    getAllFoods() {
        ...
        this.foods = this.foodsFire.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(changes => changes.map(c => (Object.assign({ key: c.payload.key }, c.payload.val())))));
        return this.foods;
    }
